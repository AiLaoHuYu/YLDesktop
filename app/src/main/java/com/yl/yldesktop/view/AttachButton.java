        ...
        if (customIsDrag) {
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE://手指滑动
                    if (mRawX >= 80 && mRawX <= mRootMeasuredWidth && mRawY >= mRootTopY && mRawY <= (mRootMeasuredHeight + mRootTopY)) {
                        //手指X轴滑动距离
                        ...
                        //X轴边界限制
                        endX = endX < 80 ? 80 : endX > maxX ? maxX : endX;
                        //Y轴边界限制
